          ...
          <div className="relative z-10 flex flex-col h-full">
            <div>
              ...
              <p className={`text-sm leading-relaxed max-w-[220px] ${darkMode ? "text-red-200" : "text-red-600"}`}>
                  "Turning care into independence. Technology that sees, Guiding every step with trust."               </p>
            </div>
            <div className="mt-16">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="text-center mt-2">
              <p className={`text-xs ${darkMode ? "text-red-300" : "text-red-600"}`}>
                ...
                <Link href="/auth/sign-up" className={`${darkMode ? "text-red-500" : "text-red-600"} hover:underline ml-1`}>
                  Register
                </Link>
              </p>
            </div>
