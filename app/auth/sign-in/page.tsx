    ...
    <div className="dark min-h-screen flex items-center justify-center bg-[#171f2c] relative overflow-hidden font-sans">
      ...
      <div className="relative flex flex-col md:flex-row w-full max-w-[800px] min-h-[460px] mx-4 rounded-2xl shadow-2xl overflow-hidden bg-[#242b3b]/60 backdrop-blur-xl border border-white/5">
        ...
        <div className="w-full md:w-7/12 p-10 bg-[#1e2532]/80 z-10 flex flex-col justify-center">
          <h2 className="text-xl font-bold text-white mb-8">Sign In</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex items-center mt-1 mb-2">
              <input
                id="remember"
                type="checkbox"
                className="w-4 h-4 rounded border-white/20 bg-[#131924]/80 text-[#3ab7e9] focus:ring-[#3ab7e9] focus:ring-offset-[#1e2532]"
              />
              <label htmlFor="remember" className="ml-2 text-xs text-white/40 cursor-pointer select-none">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#4f8bea] to-[#42d1f5] text-white font-medium py-3 rounded-lg hover:opacity-90 transition-opacity flex justify-between items-center px-5 shadow-lg shadow-[#42d1f5]/20"
            >
            ...
            <div className="text-center mt-2">
              <p className="text-xs text-white/40">
                ...
                <Link href="/auth/sign-up" className="text-[#42d1f5] hover:underline ml-1">
                  Register
                </Link>
              </p>
            </div>
